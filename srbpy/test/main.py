...
from srbpy.alignment.align_pqx import Straight, EITypeID, LeftRightEnum, Sprial, PQX
...
# 3, 500.99900199501394000000, 1255.00000000000000000000, 1

m1k = PQX(file="00-MainLine/M1K-0312/M1K-0312.ICD")
x = m1k.get_coordinate(18645.000258927972)
print(x)
